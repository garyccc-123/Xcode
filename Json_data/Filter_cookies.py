...
OUTPUT_FILE = '/Users/gary/Documents/Supermarket1/Json_data/filtered_cookies.json'

def load_products():
    """
    读取两个 JSON，筛出「餅乾、曲奇」子分类的记录，仅保留 uid / eng 字段
    """
    items = []
    ...
    logging.info(f'载入餅乾、曲奇原始记录：{len(items)} 条')
    return items
