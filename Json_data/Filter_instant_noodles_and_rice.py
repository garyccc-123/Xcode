...
OUTPUT_FILE = '/Users/gary/Documents/Supermarket1/Json_data/filtered_instant_noodles_and_rice.json'

def load_products():
    """
    读取两个 JSON，筛出「即食粉麵/飯」子分类的记录，仅保留 uid / eng 字段
    """
    items = []
    ...
    logging.info(f'载入即食粉麵/飯原始记录：{len(items)} 条')
    return items
