...
OUTPUT_FILE = '/Users/gary/Documents/Supermarket1/Json_data/filtered_baking_ingredients.json'

def load_products():
    """
    读取两个 JSON，筛出「麵粉、烘焙用料、梳打粉」子分类的记录，仅保留 uid / eng 字段
    """
    items = []
    ...
    logging.info(f'载入麵粉、烘焙用料、梳打粉原始记录：{len(items)} 条')
    return items
